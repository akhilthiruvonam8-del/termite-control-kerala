      ...
      <div className="relative z-10">
        ...
        <section className="py-20 border-b border-emerald-950/80 bg-black/60 backdrop-blur-md" id="panchayats">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* Master Explorer Container with Frosted Glassmorphism */}
            <div className="bg-[#031710]/90 rounded-3xl p-6 sm:p-8 border border-emerald-500/30 backdrop-blur-xl shadow-2xl max-w-6xl mx-auto">
              
              <div className="flex flex-col md:flex-row md:items-center justify-between mb-6 gap-4 pb-6 border-b border-emerald-900/40">
                <div>
                  <div className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs font-bold uppercase tracking-wider mb-2">
                ...
                <div className="relative w-full md:w-72">
                  ...
                  <input
                    ...
                    className="w-full bg-[#020d09] border border-emerald-500/40 rounded-xl pl-10 pr-4 py-2 text-xs text-white placeholder-slate-400 focus:outline-none focus:border-emerald-400 transition shadow-inner"
                  />
                </div>
              </div>

              {/* Block Filter Tabs (Smooth Horizontal Scroll) */}
              <div className="flex items-center space-x-2 overflow-x-auto pb-3 mb-6 scrollbar-thin scrollbar-thumb-emerald-800">
                <button
                  onClick={() => setSelectedBlock('all')}
                  className={`px-3.5 py-1.5 rounded-xl text-xs font-bold whitespace-nowrap transition ${
                    selectedBlock === 'all' 
                      ? 'bg-emerald-400 text-slate-950 shadow-lg shadow-emerald-500/30' 
                      : 'bg-[#020d09]/80 text-slate-300 hover:bg-emerald-950 border border-emerald-900/50'
                  }`}
                >
                  All 11 Blocks (68)
                </button>
              ...
              <div className="flex items-center justify-between text-[11px] text-emerald-400/90 mb-3 px-1">
                <span>Showing <strong className="text-white font-bold">{filteredPanchayats.length}</strong> Panchayats</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5 max-h-[460px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-emerald-500/50 hover:scrollbar-thumb-emerald-400 scrollbar-track-[#020d09]/60">
                {filteredPanchayats.length > 0 ? (
                  filteredPanchayats.map((p, idx) => (
                    <div 
                      key={idx}
                      className="p-4 rounded-2xl bg-[#020d09]/85 border border-emerald-500/25 hover:border-emerald-400/60 transition-all duration-300 group flex flex-col justify-between shadow-lg hover:shadow-emerald-900/20"
                    >
                      <div>
                        <div className="flex items-center justify-between mb-1.5">
                          <span className="text-[10px] font-bold text-emerald-300 bg-emerald-950 px-2 py-0.5 rounded-md border border-emerald-800/60">
                            {p.blockName}
                          </span>
                      ...
                      <div className="mt-3 pt-2 border-t border-emerald-950/80 flex items-center justify-between">
                        ...
                        <button
                          ...
                          className="text-[11px] text-emerald-300 hover:text-emerald-200 font-bold flex items-center space-x-1 group/btn"
                        >
                          <span>Book Free Inspection</span>
              ...
              <div className="mt-6 pt-4 border-t border-emerald-900/40 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-300 gap-3">
                ...
                <button
                  ...
                  className="font-bold text-emerald-400 hover:text-emerald-300 flex items-center space-x-1.5 bg-emerald-950/60 border border-emerald-500/30 px-3.5 py-1.5 rounded-full transition"
                >
