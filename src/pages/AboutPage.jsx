...
export default function AboutPage({ onOpenJoinModal }) {
  ...
  const leaders = [
    ...
    },
    {
      ...
      email: 'sajish@greenlinepest.com',
    ...
    },
    {
      ...
      email: 'mahesh@yessemfacilities.com',
    ...
    },
    {
      ...
      email: 'binu@globalmarketingcbe.com',
    ...
    },
    {
      ...
      email: 'anjana@mithrakulamtrust.org',
